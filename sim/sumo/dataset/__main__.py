...
Usage:
    python -m sim.sumo.dataset --realism [none/low/med/high] [simulation_name] [experiment_name]
"""
...
spec = importlib.util.spec_from_file_location("sumo_dataset_module", _dataset_module_path)
...
Realism levels:
  ...
  high  - High noise, frequent failures, significant errors (15% failures)
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help='Output directory for CSV files (default: data/<experiment_name> or data/<simulation_name>)'
    )
