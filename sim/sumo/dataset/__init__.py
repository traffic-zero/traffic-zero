...
# Import from parent module (sim/sumo/dataset.py) using importlib to avoid circular imports
import importlib.util
from pathlib import Path

# Load the parent dataset.py module directly
_dataset_module_path = Path(__file__).parent.parent / "dataset.py"
spec = importlib.util.spec_from_file_location("sumo_dataset", _dataset_module_path)
