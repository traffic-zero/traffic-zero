...
Usage:
    ...
    python -m sim.sumo --realism [none/low/med/high] [simulation_name]
    [experiment_name]
...
if __name__ == "__main__":
    ...
    if "--realism" in sys.argv:
        # Dataset mode: python -m sim.sumo --realism [level]
...
Realism levels:
  ...
  high  - High noise, frequent failures, significant errors (15% failures)
        ...
        if len(sys.argv) < 2:
            print(
                """Usage: python -m sim.sumo <simulation_name>
                   python -m sim.sumo --realism [none/low/med/high]
                   [simulation_name] [experiment_name]
            Example: python -m sim.sumo simple4
            Example: python -m sim.sumo --realism low simple4"""
            )
            sys.exit(1)
