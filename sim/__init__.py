...
def run_carla(*args, **kwargs):
    ...
    This function bridges SUMO traffic simulation with CARLA's 3D
    environment, allowing vehicles to be rendered in CARLA while being
    controlled by SUMO. This enables realistic 3D visualization and
    interaction with traffic scenarios.
